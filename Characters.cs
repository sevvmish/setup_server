        ...
        private Characters CreateDefaultCharacter(int playerType, string newTalents)
        {
            ...
            switch (playerType)
            {
                ...
                case 3: //barbarian
                    ...
                    {
                        case "0":
                            return new Characters(0.9f, 360, 1, 0, "5-10", 20, 80, 0, 10, 1, 1, 5, 1, 1, 101, 102, 103, 106, 104, 1020, "", "0,101,102,103,104,105,106,109", newTalents);

                        case "1":
                            return new Characters(0.9f, 325, 2, 0, "6-11", 20, 80, 0, 10, 1, 1, 5, 1, 1, 109, 111, 103, 108, 104, 1015, "", "0,101,102,103,104,105,106,108,109,111,112", newTalents);

                        case "2":
                            return new Characters(0.9f, 300, 3, 0, "7-12", 20, 80, 0, 10, 1, 1, 5, 1, 1, 109, 111, 110, 112, 104, 1015, "", "0,101,102,103,104,105,106,108,109,110,111,112", newTalents);
                    }
                ...
                case 4: //rogue
                    ...
                    {
                        case "0":
                            return new Characters(1.1f, 265, 1, 15, "1-4", 7, 50, 0, 1, 10, 1, 10, 1, 1, 152, 154, 156, 175, 158, 153, "", "0,151,152,154,155,156,158,159,160,161,162,165,175,178", newTalents);

                        case "1":
                            return new Characters(1.1f, 240, 1, 15, "1-4", 7, 50, 0, 1, 10, 1, 10, 1, 1, 152, 154, 163, 176, 172, 153, "", "0,151,152,154,155,158,159,160,161,162,163,165,172,175,176,177,178", newTalents);

                        case "2":
                            return new Characters(1.1f, 215, 1, 20, "1-4", 7, 50, 0, 1, 10, 1, 10, 1, 1, 152, 154, 164, 176, 158, 153, "", "0,151,152,154,155,158,159,160,161,162,163,164,165,175,176,177,178", newTalents);
                    }
