        ...
        private Characters CreateDefaultCharacter(int playerType, string newTalents)
        {
            ...
            switch (playerType)
            {
                case 1: //warrior
                    ...
                    {
                        case "0":
                            return new Characters(1, 300, 1, 0, "1-6", 12, 120, 6, 3, 1, 1, 7, 1, 1, 9, 5, 12, 4, 17, 1020, "", "0,1,2,4,5,6,9,11,12,15,17", newTalents);

                        case "1":
                            return new Characters(1, 275, 1, 0, "2-7", 15, 50, 4, 1, 1, 1, 10, 1, 1, 9, 8, 12, 13, 3, 1020, "", "0,1,3,4,5,6,7,8,9,11,12,13,15", newTalents);

                        case "2":
                            return new Characters(1, 335, 1, 0, "1-6", 10, 200, 12, 5, 1, 1, 5, 1, 1, 5, 6, 10, 11, 19, 1020, "", "0,1,4,5,6,8,9,10,11,12,15,16,19", newTalents);
                ...
                case 2: //elementalist
                    ...
                    {
                        case "0":
                            return new Characters(1, 240, 1, 1, "1-1", 1, 20, 0, 1, 1, 10, 1, 10, 20, 53, 52, 66, 75, 61, 51, "", "0,52,53,54,55,60,61,63,66,75", newTalents);

                        case "1":
                            return new Characters(1, 240, 1, 1, "1-1", 1, 20, 0, 1, 1, 10, 1, 10, 20, 55, 78, 76, 74, 60, 56, "", "0,52,54,55,60,61,63,74,76,78,79", newTalents);

                        case "2":
                            return new Characters(1, 240, 1, 1, "1-1", 1, 20, 0, 1, 1, 10, 1, 10, 20, 53, 52, 78, 73, 62, 65, "", "0,51,52,53,54,55,56,60,61,62,63,68,73,78", newTalents);
                    }
                ...
                case 3: //barbarian
                    ...
                    {
                        case "0":
                            return new Characters(0.85f, 360, 1, 0, "5-10", 20, 80, 0, 10, 1, 1, 5, 1, 1, 101, 102, 103, 106, 104, 1020, "", "0,101,102,103,104,105,106,109", newTalents);

                        case "1":
                            return new Characters(0.85f, 325, 2, 0, "6-11", 20, 80, 0, 10, 1, 1, 5, 1, 1, 109, 111, 103, 108, 104, 1015, "", "0,101,102,103,104,105,106,108,109,111,112", newTalents);

                        case "2":
                            return new Characters(0.85f, 300, 3, 0, "7-12", 20, 80, 0, 10, 1, 1, 5, 1, 1, 109, 111, 110, 112, 104, 1015, "", "0,101,102,103,104,105,106,108,109,110,111,112", newTalents);
                    }
                ...
                case 4: //rogue
                    ...
                    {
                        case "0":
                            return new Characters(1.15f, 265, 1, 15, "1-4", 7, 50, 0, 1, 10, 1, 10, 1, 1, 152, 154, 156, 175, 158, 153, "", "0,151,152,154,155,156,158,159,160,161,162,165,175,178", newTalents);

                        case "1":
                            return new Characters(1.15f, 240, 1, 15, "1-4", 7, 50, 0, 1, 10, 1, 10, 1, 1, 152, 154, 163, 176, 172, 153, "", "0,151,152,154,155,158,159,160,161,162,163,165,172,175,176,177,178", newTalents);

                        case "2":
                            return new Characters(1.15f, 215, 1, 20, "1-4", 7, 50, 0, 1, 10, 1, 10, 1, 1, 152, 154, 164, 176, 158, 153, "", "0,151,152,154,155,158,159,160,161,162,163,164,165,175,176,177,178", newTalents);
                    }
                ...
                case 5: //wizard
                    ...
                    {
                        case "0":
                            return new Characters(1, 240, 1, 1, "1-1", 1, 24, 0, 1, 1, 10, 1, 10, 20, 201, 221, 207, 220, 210, 215, "", "0,201,203,204,205,206,207,210,212,214,218,219,220,221,222,223", newTalents);

                        case "1":
                            return new Characters(1, 240, 1, 1, "1-1", 1, 20, 0, 1, 1, 5, 1, 10, 20, 221, 212, 207, 219, 205, 209, "", "0,201,203,204,205,206,207,208,210,212,214,217,218,219,220,221,222,223", newTalents);

                        case "2":
                            return new Characters(1, 240, 1, 1, "1-1", 1, 20, 0, 1, 1, 5, 1, 10, 20, 221, 208, 217, 227, 222, 202, "", "0,201,203,204,205,206,207,208,210,212,214,217,218,219,220,221,222,223", newTalents);
                    }
